...
for(i in 1:dim(tk1)[1]){
  ...
  if(conn_hacienda_san_juan[i,6]=="male"){ #Gender-dispersion factor
...
write.csv(as.data.frame(xf_all),"diarrhea-Hacienda San Juan-sim-4-new-1000-dist1-30.csv") # need to run from 14 - 85
